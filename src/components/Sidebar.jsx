  ...
  return (
    <aside className="sidebar" style={{ width: 196, minWidth: 196, padding: "14px 10px" }}>
      <div className="sidebar__brand" style={{ padding: "6px 8px 10px", gap: 8 }}>
        ...
        <div>
          <div className="sidebar__name" style={{ fontSize: 13 }}>Pure AI</div>
          <div className="sidebar__role" style={{ fontSize: 11 }}>Admin Console</div>
        </div>
      </div>

      <nav className="nav" style={{ gap: 10 }}>
        <div className="nav__section">
          <div className="nav__title" style={{ fontSize: 10, margin: "6px 8px 4px" }}>Main</div>
      ...
      <div className="sidebar__footer" style={{ paddingTop: 10 }}>
        <div className="hintPill" style={{ fontSize: 10, padding: "6px 8px" }}>
...
function IconMenu()     { return <Svg><path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2" stroke="currentColor" strokeWidth="1.6" /><path d="M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v0a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2Z" stroke="currentColor" strokeWidth="1.6" /><path d="M9 12h6M9 16h4" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" /></Svg>; }
function IconClock()    { return <Svg><circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="1.6" /><path d="M12 7v5l3 3" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" /></Svg>; }
function IconBag()      { return <Svg><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4Z" stroke="currentColor" strokeWidth="1.6"/><path d="M3 6h18M16 10a4 4 0 0 1-8 0" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"/></Svg>; }